...
INSERT INTO `Employees` VALUES (1,'Chris Gayle',1000000,1),(2,'Michael Clarke',800000,2),(3,'Rahul Dravid',700000,1),(4,'Rickey Ponting',600000,2),(5,'Albie Morkel',650000,2),(6,'Wasim Akram',750000,3);
...
CREATE TABLE `commissions` (
  ...
  KEY `commissions_amount_index` (`AMOUNT`),
...
-- Dump completed on 2014-09-10 14:23:40
